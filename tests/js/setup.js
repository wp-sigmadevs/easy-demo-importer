...
globalThis.sdEdiAdminParams = {
	...
	logRegenLabel: 'Thumbnail Regeneration',
	logManualLabel: 'Manual Import',
	logUnknownDemo: 'Import',
	logSuccess: 'Success',
	logWarning: 'Completed with warnings',
	logFailed: 'Failed',
	logInProgress: 'In progress',
	logInterrupted: 'Interrupted',
	logShareTitle: 'Easy Demo Importer — Import Log',
	logShareRunsHeading: 'Import Runs',
	logShareStarted: 'Started',
	logShareFinished: 'Finished',
	logShareEntries: 'Entries',
	logGroupRepeated: 'similar entries',
	logGroupShowAll: 'Show all',
	logGroupHide: 'Hide',
};
