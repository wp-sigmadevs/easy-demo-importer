	...
	private function localizeData() {
		return [
			...
			'data'   => [
				...
				'snapshotHint'               => esc_html__( 'Back up your content before importing so this import can be rolled back. Restoring reverts the site to this moment — anything added after is lost.', 'easy-demo-importer' ),
				...
				'manualWarning'              => esc_html__( 'This imports into your current site. Keep the restore point on so you can roll back.', 'easy-demo-importer' ),
