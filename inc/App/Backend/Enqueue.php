	...
	private function localizeData() {
		return [
			...
			'data'   => [
				...
				'manualUploadTitle'          => esc_html__( 'Upload Your Export Files', 'easy-demo-importer' ),
				'manualFilesLabel'           => esc_html__( 'Files', 'easy-demo-importer' ),
				'manualChooseFile'           => esc_html__( 'Choose File', 'easy-demo-importer' ),
				...
				'manualBundleLabel'          => esc_html__( 'Bundle (.zip: content, customizer, widgets, settings, images) — required', 'easy-demo-importer' ),
				'manualImagesLabel'          => esc_html__( 'Images (.zip, mirrors the uploads folder) — optional', 'easy-demo-importer' ),
				...
				'manualContentLabel'         => esc_html__( 'Content (WXR / XML) — required', 'easy-demo-importer' ),
				...
				'manualSettingsLabel'        => esc_html__( 'Settings — single .json, or a .zip of per-option JSONs — optional', 'easy-demo-importer' ),
				...
				'discardButton'              => esc_html__( 'Discard restore point', 'easy-demo-importer' ),
