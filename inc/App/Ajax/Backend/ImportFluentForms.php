...
class ImportFluentForms extends ImporterAjax {
	...
	public function response() {
		...
		$this->prepareResponse(
			...
			$formsExists ? esc_html__( 'Fluent Forms imported!', 'easy-demo-importer' ) : esc_html__( 'No Fluent Forms found. Skipping.', 'easy-demo-importer' ),
			false,
			'',
			'',
			$formsExists ? esc_html__( 'Fluent Forms imported.', 'easy-demo-importer' ) : null
		);
	}
